...
public class ActivityServiceImpl implements ActivityService {
    ...
    public List<String> getSearchSuggestions(String term) {
        ...
        return activityRepository.findAll((root, query, cb) -> cb.or(
                cb.like(cb.lower(root.get("state")), searchLower),
                cb.like(cb.lower(root.get("eventCategory")), searchLower),
                cb.like(cb.lower(root.get("eventDescription")), searchLower)
        )).stream()
                .flatMap(a -> Stream.of(a.getState(), a.getEventCategory(), a.getEventDescription()))
    ...
    @Override
    public List<Activity> getActivitiesByStateAndEventCategory(String state, String eventCategory) {
        return activityRepository.findByStateAndEventCategory(state, eventCategory);
    }
